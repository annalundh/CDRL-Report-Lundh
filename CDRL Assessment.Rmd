...
## The descriptive statistics, which are detailed below, allow visualization of the mean, median and mode of the major variables, like systolic and diastolic BP, weight and age. Histograms were made using the data from weight, systolic and diastolic variables, in order to visualize the spread of this data. 
